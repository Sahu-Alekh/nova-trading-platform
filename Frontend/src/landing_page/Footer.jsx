        ...
        <footer>
            <div className="container border-top mt-5">
                <div className="row mt-5">
                    <div className="col">
                        <img src="public/images/logo.png" style={{ width: "50%" }} alt="" />
                        <p className="copyright">&copy; 2010 - 2025, Nova Broking Ltd. <br /> All rights reserved.</p>
                    ...
                    <div className="col tags">
                        ...
                        <a href="" >Careers</a><br />
                        <a href="" >Nova Cares (CSR)</a><br />
                        <a href="" >Nova.tech</a><br />
                        <a href="" >Open source </a><br />
                    </div>
                </div>
                <div className="mt-5 text-muted" style={{fontSize:"14px"}}>
                    <p>Nova Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Nova Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: Nova Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@Nova.com, for DP related to dp@Nova.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
                    ...
                    <p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers. Receive information of your transactions directly from Exchange on your mobile/email at the end of the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities markets - once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to trade on behalf of others. If you find anyone claiming to be part of Nova and offering such services, please create a ticket here.</p>
