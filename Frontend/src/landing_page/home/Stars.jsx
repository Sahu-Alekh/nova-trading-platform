        ...
        <div className="container mt-5">
            <div className="row p-5 mt-5">
                <div className="col-5 p-5">
                    ...
                    <p className="text-muted mb-5">That's why 1.6+ crore customers trust Nova with ~ ₹6 lakh crores of equity investments, making us India’s largest broker; contributing to 15% of daily retail exchange volumes in India</p>
                    ...
                    <h2 className="fs-4">The Nova universe</h2>
                ...
                <div className="col-7 p-5">
                    <img src="/images/ecosystem.png" alt="" style={{ width: "92%" }} />
